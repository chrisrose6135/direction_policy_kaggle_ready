...
def get_spread_control(cfg: dict[str, Any] | None) -> dict[str, Any]:
    ...
    scfg.setdefault("default_fallback_min_spread_points", 2.0)
    return scfg
...
def fallback_min_spread_points(symbol: str, cfg: dict[str, Any] | None = None) -> float:
    ...
    return float(scfg.get("default_fallback_min_spread_points", DEFAULT_FALLBACK_MIN_SPREAD_POINTS.get(symbol_u, 2.0)))

...
def main() -> None:
    p = argparse.ArgumentParser(
        description='Prepare Kaggle raw forex CSVs into the project data/raw/SYMBOL_TIMEFRAME.csv format.'
    )
    p.add_argument('--input-dir', required=True, help='Kaggle raw dataset directory, e.g. /kaggle/input/my-forex-raw-data')

...
def calculate_spread_profile(df: pd.DataFrame, symbol: str, cfg: dict[str, Any]) -> dict[str, Any]:
    ...
    pips_per_point = float(labels.get("spread_pips_per_point", 0.1))
    fallback_points = float(labels.get("default_spread_points", 2.0))
    ...
    return {
        ...
        "spread_pips_per_point": pips_per_point,
        ...
        "median_spread_pips": round(median_points * pips_per_point, 6),
        "p95_spread_pips": round(p95_points * pips_per_point, 6),
        "selected_default_spread_points": round(median_points, 6),
        "selected_default_spread_pips": round(median_points * pips_per_point, 6),
        "selected_max_spread_points": round(p95_points, 6),
        "selected_max_spread_pips": round(p95_points * pips_per_point, 6),
    }
...
def apply_symbol_spread_profile_to_cfg(cfg: dict[str, Any], profile: dict[str, Any]) -> dict[str, Any]:
    ...
    labels["spread_pips_per_point"] = float(profile.get("spread_pips_per_point", labels.get("spread_pips_per_point", 0.1)))
    ...
    *,
    ...
    return {
        "generated_spread_risk": {
            ...
            "spread_pips_per_point": float(labels.get("spread_pips_per_point", 0.1)),
            "symbols": symbols,
        },
        "risk": {
